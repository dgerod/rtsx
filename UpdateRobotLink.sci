...
// Usage: robot=UpdateRobotLink(robot,i,<param1, value1>,<param2,value2> ...)
// where i = link index and <parameter, value> pairs are (put all strings/characters in quotes)
...
UpdateRobotLink = _Update_Robot_Link;
updaterobotlink = _Update_Robot_Link;
